 ...
 */
public class JsonGzipFormat implements Format<HdfsSinkConnectorConfig, Path> {
   ...
   */
  public JsonGzipFormat(HdfsStorage storage) {
  ...
  public RecordWriterProvider<HdfsSinkConnectorConfig> getRecordWriterProvider() {
    return new JsonGzipRecordWriterProvider(storage, converter);
  }
