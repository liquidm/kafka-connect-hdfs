 ...
 */
public class JsonGzipRecordWriterProvider implements RecordWriterProvider<HdfsSinkConnectorConfig> {

  private static final Logger log = LoggerFactory.getLogger(JsonGzipRecordWriterProvider.class);
   ...
   */
  JsonGzipRecordWriterProvider(HdfsStorage storage, JsonConverter converter) {
        ...
        public void write(SinkRecord record) {
          ...
          try {
            ...
            if (value instanceof Struct) {
              ...
              gzipOut.write(rawJson);
              gzipOut.write(LINE_SEPARATOR_BYTES);
            } else {
